# reveal.js CETIC theme

See the CETIC reveal theme here: https://cetic.github.io/reveal.js

## Quickstart

Fork this repository and modify `index.html`, then open that file in your browser.
